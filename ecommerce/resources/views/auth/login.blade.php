    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-login">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ route('login') }}" id="login-form" action="AddUser" method="post" role="form" style="display: block;">
                        	 {{ csrf_field() }}
                            <div class="form-group" class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <!--------------------------End Login--------------------------------------------------->
                         <form id="register-form" action="{{ route('register') }}" method="post"style="display: none;">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" >
                                ...
                                <input asp-for="name" type="text" name="name" id="username" tabindex="1" class="form-control" placeholder="Username" value="">
                            ...
                            <div class="form-group" >
                                ...
                                <input id="password" tabindex="3" class="form-control" placeholder="Confirm Password" type="password" name="password_confirmation" required>
                            </div>
